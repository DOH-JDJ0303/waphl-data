...
from shared.aws_ops import log_print, parse_uri, s3_file_exists
...
TERRA_WORKSPACE = os.environ.get('TERRA_WORKSPACE')
TERRA_SUBMISSIONID = os.environ.get('TERRA_SUBMISSIONID')
TERRA_WORKFLOW = os.environ.get('TERRA_WORKFLOW')
TERRA_SUBMISSIONENTITY = os.environ.get('TERRA_SUBMISSIONENTITY')  # entity_type
TERRA_SUBMISSIONTIME = os.environ.get('TERRA_SUBMISSIONTIME')
...
def create_terra_table(entities, value_attrs, file_attrs):
    ...
    table_file = "/tmp/terra_table.csv"
